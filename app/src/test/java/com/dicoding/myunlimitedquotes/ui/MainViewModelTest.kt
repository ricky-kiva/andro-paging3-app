...
import com.dicoding.myunlimitedquotes.utils.LiveDataTestUtil.getOrAwaitValue
...
class MainViewModelTest {
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        ...
        // diff between 2 version of PagingData & dispatch necessary updates to adapter
        // this case diff `current` & `previous` version of `actualQuote` `PagingData` object
...
// this specify no actual updates should be made to adapter when changes occur
